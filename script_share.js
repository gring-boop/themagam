...
(function () {
  ...
  const SHARE_INTERVAL_MS = 10000;        // 10초에 한 장
  ...
  const SHARE_STALE_MS    = SHARE_INTERVAL_MS * 4;   // 네 장 놓치면 "끊김"(흐리게)
  const SHARE_DROP_MS     = SHARE_INTERVAL_MS * 6;   // 여섯 장 놓치면 목록에서 뺍니다
