...
/* ---- 9. 접속 판정 — 오래 방치해도 사라지지 않아야 ---- */
{
  ...
  /* [고침 2026-08-06] 유예가 15분 → 30분으로 늘었습니다(크롬 절전 대비).
     20분은 이제 "아직 접속 중"이 맞고, 40분이 제외 대상입니다. */
  ok( isOnline({disconnectedAt:now-20*60*1000,lastSeen:now-20*60*1000},now),"20분 전 끊김은 유예 안");
  ok(!isOnline({disconnectedAt:now-40*60*1000,lastSeen:now-40*60*1000},now),"40분 전 끊김은 제외");
