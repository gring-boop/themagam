...
const MANUAL_SECTIONS = [
  {
    ...
    html: `
      ...
      <p class="man-p">이 방은 <b>방장이 승인한 필명만</b> 들어올 수 있어요.
      주소를 알아도 승인 전에는 입장이 되지 않습니다.</p>

      <table class="man-t"><tbody>
        <tr><td><b>먼저 할 일</b></td><td>쓰실 <b>필명을 방장에게</b> 알려주세요.
            승인이 끝나면 그때부터 들어올 수 있어요</td></tr>
        <tr><td><b>승인 전에 들어가면</b></td><td>“아직 승인되지 않은 필명이에요” 라고 뜨고
            입장이 멈춥니다. <b>고장이 아니에요</b> — 방장에게 말씀만 주시면 됩니다</td></tr>
        <tr><td><b>이미 쓰던 분</b></td><td><b>아무것도 안 하셔도 돼요.</b>
            쓰시던 필명은 이미 명단에 있습니다</td></tr>
        <tr><td><b>필명을 바꾸고 싶으면</b></td><td>새 필명도 <b>승인이 따로 필요해요.</b>
            바꾸기 전에 방장에게 먼저 말씀해 주세요</td></tr>
      </tbody></table>

      <div class="man-tip">
        <b>왜 생겼나 —</b> 아무나 주소만 알면 들어올 수 있던 때에, 모르는 필명이
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>✍️ 글자수</b></td><td>그래프가 <b>둘</b>이에요.
            위는 <b>월~일 한 주</b> — ‹ › 로 지난 주도 넘겨봅니다.
            아래는 <b>최근 7일 꺾은선</b> — 주가 바뀌어도 안 끊겨서 요즘 페이스가 보여요.
            아래 그래프는 ‹ › 를 따라가지 않고 늘 오늘까지입니다</td></tr>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td>⚙️ 설정</td><td>탭 다섯이에요 —
            <b>💬 채팅 · 👤 프로필 · 🍅 뽀모 · 🎨 테마 · 🔒 개인정보</b>.<br>
            <b>🍅 뽀모</b> 에서 타이머 <b>모양(원형·가로 바)</b>과 <b>알림음</b>을 정합니다</td></tr>
