...
const MANUAL_SECTIONS = [
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td>🗂️ 나의 작업</td><td>출석 달력 · 할 일 · 목표 · 기록</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>남의 카드</b></td><td>눌리지 않아요. 작업 시간 기록은 <b>본인만</b> 머리말의 🗂️ 나의 작업 → 📊 기록에서 봅니다</td></tr>
      </tbody></table>
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td>■ 빨간 버튼</td><td>정지 — <b>내 타이머만</b> 멈춰요</td></tr>
        <tr><td>소리·알림</td><td>스위치를 끄면 <b>조용히</b> 돌아갑니다. 타이머와 🍅 집중 횟수는 그대로예요</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <p class="man-p">이 둘은 <b>내 카드의 아래칸을 눌러서</b> 엽니다.</p>

      <div class="man-h2">🗂️ 나의 작업 — 머리말의 버튼</div>
      <p class="man-p">출석 달력과 할 일, 오늘 목표, 작업 기록을 한 창에서 봅니다.</p>
      <table class="man-t"><tbody>
        <tr><td><b>달력</b></td><td>입장만 해도 붉은 <b>✓ 도장</b>이 찍혀요. 그날 할 일이 있으면 칸 오른쪽 위에 <b>작은 점</b>이 붙고, 다 끝냈으면 옅어집니다</td></tr>
        <tr><td><b>한 번 누르기</b></td><td>그 <b>날짜를 고릅니다</b> — 오른쪽 📌 할 일이 그날 것으로 바뀌어요</td></tr>
        <tr><td><b>두 번 누르기</b></td><td>그날을 <b>🏖️ 휴가</b>로 표시하거나 풉니다</td></tr>
        <tr><td><b>📌 할 일</b></td><td>고른 날짜의 할 일과, 그 아래 <b>📎 날짜 없는 할 일</b>. 양쪽 다 여기서 바로 추가돼요</td></tr>
        <tr><td><b>🎯 목표</b></td><td>오늘 목표 한 줄과 <b>⏱️ 오늘 작업 시간 초기화</b></td></tr>
        <tr><td><b>📊 기록</b></td><td>주간 작업 시간과 글자수 그래프 · 텍스트로 내보내기</td></tr>
        <tr><td><b>누가 보나</b></td><td>할 일과 목표는 <b>다른 작가님들에게는 보이지 않아요.</b>
            방장은 방을 챙기기 위해 관리자 화면에서 모아 볼 수 있습니다</td></tr>
        <tr><td><b>🧹 치우기</b></td><td>카드 팝업에서 <b>완료한 것 치우기</b>를 누르면 그 목록에서만 사라지고,
            🗂️ 나의 작업에는 <b>완료된 채로 남습니다</b> — 지운 게 아니에요</td></tr>
      </tbody></table>

      <div class="man-tip">
        <b>어디에 무엇이 보이나요?</b><br>
        카드 아래칸의 <b>목표 · 투두</b> 팝업에는 <b>오늘 할 일</b>과 <b>날짜 없는 할 일</b>만 나옵니다.
        다음 주에 할 일을 적어두면 지금은 안 보이다가 <b>그날이 되면 저절로</b> 거기에도 떠요.
        모든 날짜를 한눈에 보고 싶을 때 🗂️ 나의 작업의 달력을 씁니다.<br>
