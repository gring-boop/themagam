  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>상태표를 누르면</b></td><td>누를 때마다 <b>🔥WORK🔥 → ☕BREAK☕ → 💤AWAY💤</b> 차례로 바뀌어요</td></tr>
        <tr><td>접속 표시</td><td>아래쪽 상자의 <b>작은 점</b>. <b>초록</b>이면 접속 중, 인터넷이 끊기면 <b>붉게 깜빡여요</b></td></tr>
        <tr><td><b>아래칸을 누르면</b></td><td>오늘 목표와 나의 투두</td></tr>
        <tr><td><b>남의 카드</b></td><td>눌리지 않아요. 작업 시간 기록은 <b>본인만</b> ⚙️ 설정 → 📊 나의 작업에서 봅니다</td></tr>
      </tbody></table>
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td>Join ‣ 알림</td><td>눌러서 끄면 내 알림음이 꺼지고, <b>카드의 🍅 집중 횟수도 안 올라가요.</b> 타이머 자체는 계속 돌아갑니다. 도는 동안은 <b>starter(시작한 사람)</b>도 함께 보여요</td></tr>
