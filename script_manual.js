...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td>펫</td><td>상태표 아래에 <b>내 펫</b>이 살아요. 레벨과 다음 레벨까지의 진행 바가 함께 보입니다. 집필 시간이 쌓이면 <b>형태가 바뀌며 자랍니다</b></td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <div class="man-tip">
        상태는 <b>WORK · 🔥초집중🔥 · 휴식 · 자리비움</b> 넷이에요. <b>WORK와 초집중만 펫의 밥이 됩니다.</b> <b>카드의 상태표를 눌러</b> 바꿉니다.<br>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td><b>오른쪽 줄 접기</b></td><td>머리말 <b>❯</b>. 접으면 접속자 칸이 남은 폭을 다 씁니다. 다시 펴려면 옆에 남는 얇은 손잡이나 같은 버튼을 누르세요</td></tr>
        <tr><td>좌우 뒤집기</td><td>배치를 통째로 좌우로 뒤집어요</td></tr>
        <tr><td><b>자리 바꾸기</b></td><td>설정 → 💬 채팅 → <b>② ③ 서로 바꾸기</b>. 뽀모도로와 채팅의 위아래를 맞바꿔요</td></tr>
        ...
        <tr><td>🐾 펫</td><td>⚙️ 설정 → <b>🐾 펫</b>. <b>WORK</b>와 <b>🔥초집중</b> 시간만 쌓여서 <b>5시간에 1레벨</b>, <b>100시간에 만렙(Lv.20)</b>이에요</td></tr>
        <tr><td>Lv.1 껍데기</td><td>처음엔 <b>알 · 보자기 · 나무 상자 · 씨앗 · 선물 상자</b> 중 하나가 무작위로 와요. <b>카드의 펫을 누르면</b> 관리 창이 열리고, Lv.1 동안은 <b>껍데기를 바꿀 수 있어요.</b> 다만 <b>안에 무엇이 들었는지는 비밀</b>입니다</td></tr>
        <tr><td>자라는 모습</td><td>레벨이 오르면 <b>형태가 바뀝니다.</b> Lv.5 에 꼬리, Lv.10 에 무늬, Lv.15 에 날개나 수염이 돋고, 만렙이면 반짝여요</td></tr>
        <tr><td>도감</td><td><b>42종 42칸.</b> 만렙을 찍으면 도감에 들어가고 <b>못 모은 종류 중에서</b> 다음 펫이 뽑혀요 — 같은 게 또 나오지 않습니다</td></tr>
        <tr><td>바꾸기</td><td><b>Lv.1 동안 껍데기만</b> 바꿀 수 있어요 (안은 비밀). 깨어난 뒤에는 바꿀 수 없고, <b>색은 종류마다 정해져</b> 있습니다</td></tr>
      </tbody></table>
