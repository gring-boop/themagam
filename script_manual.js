...
const MANUAL_SECTIONS = [
  {
    ...
    html: `
      ...
      <div class="man-tip">
        <b>🔐 방장이 승인한 필명만 들어올 수 있어요.</b><br>
        지금 쓰고 계신 필명은 그대로 쓰시면 됩니다 — 아무것도 안 하셔도 돼요.
        새로 오실 분이 있으면 <b>필명을 먼저 방장에게</b> 알려주세요.
      </div>
  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        <tr><td><b>두 겹 고리</b></td><td>가운데 숫자는 지금 뽀모의 남은 시간이에요.<br>
            <b>안쪽 고리</b> — 지금 뽀모가 얼마나 갔나<br>
            <b>바깥 고리</b> — 오늘 작업 시간이 <b>하루 목표</b>에 얼마나 갔나<br>
            색은 테마의 포인트 두 가지를 그대로 써요 — 테마를 바꾸면 고리 색도 바뀝니다</td></tr>
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>[오늘 하기]</b></td><td>지난 날짜인데 <b>아직 못 끝낸</b> 할 일에 붙어요.
            누르면 <b>오늘 칸으로 옮겨집니다</b> — 글자도 반복도 그대로고 날짜만 바뀌어요</td></tr>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td><b>🖍️ 스티커</b></td><td>입력칸 안쪽 <b>🖍️</b> 를 누르면 손그림 <b>스물세 개</b>가 떠요 —
            방가방가 · 리하이 · 토닥토닥 · 파이팅 · 자리 비움 · 퇴근 · 출근 · 재출근 ·
            좋아요 · 끄덕끄덕 · 오케이 · ㅋㅋㅋ · ㅎㅎㅎ · ㅠㅠㅠ · 축하.<br>
