  ...
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>🏷️ 왼쪽 위 구석</b></td><td><b>오늘 무슨 작업인지</b> 스티커를 붙일 수 있어요 —
            💭 구상 · ✍️ 원고 · 🔍 교정 · ✂️ 수정 · 🔧 개정 · 📚 인풋 · ✨ 기타.
            상태표가 "지금 자리에 있는가"라면, 이건 "오늘 무슨 일을 하는가"예요.
        ...
        <tr><td><b>구석을 두 번 누르면</b></td><td>고르기 판이 떠요 — <b>더블클릭</b>입니다.
            ...
            맨 위의 <b>[✕ 떼기]</b> 로 다시 없앨 수 있고,
            <b>자정이 지나면 저절로 떨어져요</b> — '그날 업무'니까요</td></tr>
