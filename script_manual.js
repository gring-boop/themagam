...
const MANUAL_SECTIONS = [
  {
    ...
    html: `
      ...
      <div class="man-tip">
        ...
        칸 사이의 회색 손잡이를 <b>끌면 크기가 바뀌고</b>, 더블클릭하면 기본값으로 돌아가요.
        채팅은 <b>›</b> 로 접을 수 있어요.<br>
        <b>세 칸의 자리는 각자 원하는 대로 바꿀 수 있어요.</b> ⚙️ 설정 → 💬 채팅에서요.
      </div>
    `
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        <tr><td>맨 윗줄</td><td>왼쪽 🏆👑 출석 업적 · 오른쪽 WORK / 🔥WORK🔥 / 휴식 / 자리비움</td></tr>
        ...
        <tr><td>✏️</td><td>내 카드에만. 프사에 마우스를 올리면 나와요</td></tr>
        <tr><td>안테나 표시</td><td>아래쪽 상자 <b>왼쪽 위의 작은 안테나</b>. <b>초록</b>이면 접속 중, 인터넷이 끊기면 <b>붉게 깜빡이며 막대가 줄어요</b></td></tr>
        <tr><td><b>내 카드 아래</b></td><td><b>내 카드의 아래쪽 상자를 누르면 편집이 열려요.</b> 오늘 목표 · 상태 · 나의 투두 · 프사가 전부 거기 있습니다</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <p class="man-p">이 둘은 <b>내 카드의 아래쪽 상자를 눌러서</b> 엽니다. (또는 ⚙️ 설정 → 👤 프로필)</p>

      <p class="man-p"><b>🎯 오늘 목표 / 상태</b> — 여기 적은 목표와 상태는
      <b>다른 분들 카드에도 보여요.</b> 적는 즉시 저장되니 따로 누를 버튼은 없어요.</p>

      <p class="man-p"><b>✍️ WORK 시작!</b> 버튼을 누르면 상태가 WORK로 바뀌어요. 한 번 더 누르면 휴식으로 돌아갑니다.</p>

      <div class="man-tip">
        상태는 <b>WORK · 🔥WORK🔥(집중 중) · 휴식 · 자리비움</b> 넷 중에서 골라요.<br>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td>보기 고르기</td><td>설정에서 <b>가로 보기 / 세로 보기</b>를 골라요. 세로 모니터라면 세로 보기가 편해요</td></tr>
        <tr><td>좌우 뒤집기</td><td>배치를 통째로 좌우로 뒤집어요</td></tr>
        <tr><td><b>자리 바꾸기</b></td><td>설정 → 💬 채팅 → <b>자리마다 놓을 창</b>. 자리 그림을 보면서 ①~⑤ 에 원하는 창을 골라 넣어요</td></tr>
        <tr><td><b>창 치우기</b></td><td>자리에서 <b>— 비우기 —</b>를 고르면 그 칸이 접히고 옆 칸이 넓어져요</td></tr>
        <tr><td><b>되돌리기</b></td><td>치운 창은 화면 <b>왼쪽 위에 점선 아이콘</b>으로 남아요. 누르면 다시 나옵니다</td></tr>
        ...
        <tr><td>🏆 연속 출석</td><td>3일 이상 이어서 접속하면 카드에 배지가 붙어요. 하루라도 빠지면 처음부터</td></tr>
        <tr><td>👑 풀출석</td><td>지난주에 매일 접속했다면 카드가 금색으로 빛나요</td></tr>
      </tbody></table>

      <div class="man-tip">
        테마 · 글자 크기 · 칸 크기 · <b>자리 배치</b> · 접어둔 영역은 <b>이 기기에만</b> 저장돼요.<br>가로형과 세로형은 자리 배치를 <b>따로</b> 기억합니다.
